...
">warm stone fireplace</a>, the expansive upstairs <a href="<?php echo smarty_function_cms_selflink(array('href'=>'barn-loft'),$_smarty_tpl);?>
">barn loft</a>, the charm of The Barn will leave you and your guests with a memory that will last a lifetime. With space to accomodate over 250 people, separate areas for <a>dining</a>, <a>dancing</a>, <a>outdoor patio and deck</a> and breathtaking views of Lake Lizzie and sprawling farmland, The Barn provides the ideal four season setting for any occasion.</p><?php }} ?>