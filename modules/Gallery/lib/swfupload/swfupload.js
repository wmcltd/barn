...
SWFUpload.prototype.startResizedUpload = function (fileID, width, height, encoding, quality, allowEnlarging) {
	...
	var fileTyp = this.getFile(fileID).type;

	if(fileTyp == ".png" || fileTyp == ".PNG")
	{
		this.callFlash("StartUpload", [fileID, { "width": width, "height" : height, "encoding" : SWFUpload.RESIZE_ENCODING.PNG, "quality" : quality, "allowEnlarging" : allowEnlarging }]);
	}
	else if (fileTyp == ".gif" || fileTyp == ".GIF")
	{
		this.callFlash("StartUpload", [fileID]);
	}
	else
	{
		this.callFlash("StartUpload", [fileID, { "width": width, "height" : height, "encoding" : SWFUpload.RESIZE_ENCODING.JPEG, "quality" : quality, "allowEnlarging" : allowEnlarging }]);
	}
};
