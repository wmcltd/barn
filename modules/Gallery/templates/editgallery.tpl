...
{literal}
		...
		window.onload = function () {
			swfu = new SWFUpload({
				...
				custom_settings : {
					upload_target : "divFileProgressContainer",{/literal}
					thumbnail_height: {$maximageheight},
					thumbnail_width: {$maximagewidth},
					thumbnail_quality: {$imagejpgquality},
					msg_complete: "{$msg_complete}"{literal}
				},
