  ...
  AeGallery.prototype = {
    ...
    findImages: function() {
      ...
      thumbs.each(
        function(i) {
          ...
          var link = false;
          if(thumb.data('ae-link')) {
            link = thumb.data('ae-link');
          } else if(thumb.attr('longdesc') && thumb.attr('longdesc').length) {
            link = thumb.attr('longdesc');
          };
          var desc = false;
          if(thumb.data('ae-desc')) {
            desc = thumb.data('ae-desc');
          } else if(thumb.attr('alt') && thumb.attr('alt').length) {
            desc = thumb.attr('alt');
          };
          var title = false;
          if(thumb.data('ae-title')) {
            title = thumb.data('ae-title');
      ...
      var inter = setInterval(
        function() {
          if(thumb_count == thumbs_loaded) {
            ...
            var list = context.nav.find('.ae-thumb-list');
    ...
    _showWhenLoaded: function(index, callback) {
      if(this.images[index]) {
        ...
        this.highLightThumb(this.nav.find('.ae-thumb'+ index));
